...
class RowItem extends Component {
  ...
  _renderSubItemFlatList = ({ item }) => {
    ...
    return multiLevel && nextLevel < maxMultiLevel 
      ? (<RowItem
          {...this.props}
          ...
          _toggleItem={this._toggleSubItem}
    ...
    return (
      <View>
        <View
          key={item[uniqueKey]}
          style={[
            level <= 1 ? mergedStyles.itemWrapper : mergedStyles.subItemWrapper,
            {
              flexDirection: 'row',
              flex: 1,
              backgroundColor: mergedColors.itemBackground,
              marginLeft: level <= 1
                ? mergedStyles.itemWrapper.marginLeft
                : level * (mergedStyles.subItemWrapper.marginLeft || 10),
            },
          ]}
        >
          <TouchableOpacity
            ...
            style={[
              ...
              level <= 1 ? mergedStyles.item : mergedStyles.subItem,
              level <= 1 && this._itemSelected(item) && mergedStyles.selectedItem,
              level > 1 && this._itemSelected(item) && mergedStyles.selectedSubItem,
            ]}
          >
            ...
            <Text
              ...
              style={[
                ...
                level <= 1 ? itemFontFamily : subItemFontFamily,
                level <= 1 ? mergedStyles.itemText : mergedStyles.subItemText,
                level <= 1 && this._itemSelected(item) && mergedStyles.selectedItemText,
                level > 1 && this._itemSelected(item) && mergedStyles.selectedSubItemText,
              ]}
            >
              {item[displayKey]}
            </Text>
